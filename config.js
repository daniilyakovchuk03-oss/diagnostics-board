...
module.exports = {
  ...
  // Во сколько бот присылает сводки в группу (местное время)
  DIGEST_MORNING: '10:10',
  DIGEST_EVENING: '19:10',

  /* Обязательный минимум на каждого менеджера в день.
     Виден только руководителю. За период умножается на число дней. */
  NORMS: {
    kev:      { plan: 3,  name: 'Провести КЭВ',  unit: 'диагностик' },
    connects: { plan: 30, name: 'Дозвониться',   unit: 'дозвонов' },
  },
